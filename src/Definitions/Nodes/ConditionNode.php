...
final class ConditionNode extends AbstractWorkflowNode
{
    ...
    public static function fromArray(array $data): self
    {
        ...
        return new self(
            key: $key,
            name: $name,
            expression: is_string($expression) ? $expression : (string) $expression,
    ...
    public function toArray(): array
    {
        ...
        $payload[WorkflowDefinitionSchema::FIELD_CONFIG] = [
            WorkflowDefinitionSchema::CONFIG_EXPRESSION => $this->expression,
        ];
    ...
    private static function requireString(array $data, string $field): string
    {
        ...
        if (! is_string($value) || $value === '') {
            throw new InvalidArgumentException("Condition node field [{$field}] is required.");
        }
