...
```bash
composer require dbflowlabs/core:0.5.0-alpha.1
```
...
1. `composer require dbflowlabs/core:0.5.0-alpha.1` (or pin the latest alpha tag).
...
- Pin exact tags, such as `v0.5.0-alpha.1`
